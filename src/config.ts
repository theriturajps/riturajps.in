...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/theriturajps',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'riturajps',
  bio: 'A passionate student, I have to learn as much as possible.',
  links: [
    {
      name: 'Twitter',
      ...
      url: 'https://twitter.com/riturajps',
    },
    {
      name: 'E-Mail',
      icon: 'fa6-solid:envelope',
      url: 'mailto:iamriturajps@gmail.com',
    },
    {
      name: 'GitHub',
